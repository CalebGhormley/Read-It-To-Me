...
class FetchActivity : AppCompatActivity() {
    ...
    private fun handleBTDevice(intent: Intent) {
        ...
        if (BluetoothDevice.ACTION_FOUND == action) {
            ...
            if (deviceName.length > 3) { //for now, looking for MSU prefix
                ...
                if (prefix == "Gal") {//This is the server
     ...
     */
    fun echoMsg(msg: String, action: String) {
    ...
    private var mmSocket: BluetoothSocket? = null
        ...
        private fun manageConnectedSocket(socket: BluetoothSocket) {
            ...
            var msg = theMessage.toByteArray()
            try {
                theMessage = textToBeSaid
    ...
    companion object {
        ...
        private const val MY_UUID_STRING = "f30bdeed-dbaf-4ff5-83be-8005b74e6b84" //from www.uuidgenerator.net
